			...
			<form>
             	...
             	<div class="col-md-4 col-mragin">
	             	 <select name="dd" id="d" class="form-control1" >
	        	 			<option class="bgParent">客户姓名</option>
	        	 			<option class="bgParent">户状态</option>
	        	 			<option class="bgParent">户类型</option>
	        	 			<option class="bgParent">户来源</option>
	        	 			<option class="bgParent">户公司</option>
	        	 			<option class="bgParent">所属员工</option>
	          		 </select>
          		 </div>
				<div class="col-md-4 col-mragin">
					 <button type="submit"  class="btn">查&nbsp;询</button>
					 <button type="submit"  class="btn">分配所选客户</button>
				</div>
			</form>
		</div>
