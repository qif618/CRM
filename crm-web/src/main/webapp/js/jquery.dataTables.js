...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="form-control1"/>';
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><label style="margin-left: -15px;"/></div>').addClass( classes.sLength );
	...
	$.extend( DataTable.ext.classes, {
		...
		"sLength": "dataTables_length col-md-4",
