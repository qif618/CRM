 ...
 *
 */
public class Button1 extends TagSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7045627644531226179L;
	private String id;
	private String name;
	...
	public int doEndTag() throws JspException {
		...
		if(test){
			buffer.append("<button type='button' class='button button-rounded button-raised button-tiny ");
			if("1".equals(color)){
